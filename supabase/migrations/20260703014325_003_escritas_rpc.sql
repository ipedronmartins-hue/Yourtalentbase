-- ============================================================================
-- MIGRAÇÃO 003 · ESCRITAS POR RPC
-- O cliente deixa de escrever diretamente em tabelas (Constituição · nunca 6).
-- Corrigida contra produção: perfis nasce por trigger no signup (update-only),
-- treinador_id é uuid, posicao_principal tem CHECK de lista fechada.
-- ============================================================================
...
begin
  ...
  delete from public.atletas_360 where id=p_id;
