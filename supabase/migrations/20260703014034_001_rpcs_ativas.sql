...
-- Corrigida contra o esquema REAL de produção (2026-07-02): created_at em
-- avaliacoes/historico/elite, criado_em em treinador_treinos, cenario_id,
-- rating/dim_* como texto → ytb_num.
-- ============================================================================
