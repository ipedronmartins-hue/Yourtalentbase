...
const ATLETAS = {
  guilherme: {
    ...
    nascimento:'2007 · 17 anos', escalao:'Sub-19 · II Divisão Nacional · 2025/26',
    clube:'Gondomar SC', foto:'guilherme.jpg', fotoPos:'center 20%',
    posicao:'Médio', pe:'Esquerdo',
    stats:[{n:'17',l:'Jogos'},{n:'1390',l:'Min'},{n:'1',l:'Golos'}],
    tags:['Capitão','Líder Sub-19','3º Lugar Nacional'],
    bio:'Médio canhoto de 17 anos, capitão e líder do Gondomar SC Sub-19. Dupla nacionalidade portuguesa e brasileira. Formado no Boavista, Rio Ave e Leixões. Visão de jogo acima da média e maturidade competitiva — referência da equipa na II Divisão Nacional, actualmente em 3º lugar.',
    hist:[
      {e:'2025/26',c:'Gondomar SC',esc:'Sub-19',j:17,g:1},
      {e:'2024/25',c:'Gondomar SC',esc:'Sub-19',j:18,g:2},
      {e:'2023/24',c:'Leixões SC', esc:'Sub-19',j:14,g:0},
    ],
    palmares:[
      'Capitão Gondomar SC Sub-19 · 2025/26',
    ],
  ...
  vasco: {
    ...
    stats:[{n:'19',l:'Jogos'},{n:'638',l:'Min'},{n:'2',l:'Golos'}],
    tags:['MDC','Bicampeão Distrital','Campeão de Série'],
    bio:'Médio defensivo de 11 anos formado no Gondomar SC. Bicampeão Distrital na Divisão Elite (Sub-10 e Sub-11). Em 2025/26, sagrou-se Campeão da Série 3 do Distrital Sub-13 e disputa agora a Fase de Campeão — a disputar os quartos-de-final, com a Dragon Force pela frente. Leitura de jogo excecional para a idade.',
    hist:[
      {e:'2025/26',c:'Gondomar SC',esc:'Sub-13',j:19,g:2},
      {e:'2024/25',c:'Gondomar SC',esc:'Sub-11',j:24,g:3},
      {e:'2023/24',c:'Gondomar SC',esc:'Sub-10',j:20,g:4},
    ],
    palmares:[
      'Campeão Série 3 Sub-13 · 2025/26 · A disputar Fase de Campeão',
      'Campeão Distrital Elite Sub-11 · 2024/25',
      'Campeão Distrital Elite Sub-10 · 2023/24',
    ],
